...
void FullSystem::traceNewCoarse(FrameHessian* fh) {
  ...
  //trace_good, 100*trace_good/(float)trace_total, 			trace_skip, 100*trace_skip/(float)trace_total,
...
void FullSystem::activatePointsMT() {
  ...
  if (multiThreading)
    treadReduce.reduce(
        std::bind(&FullSystem::activatePointsMT_Reductor, this, &optimized, &toOptimize, std::placeholders::_1,
